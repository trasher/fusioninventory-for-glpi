...
CREATE TABLE `glpi_plugin_tracker_agents_processes` (
  ...
  `start_time_discovery` timestamp NULL NOT NULL DEFAULT '0000-00-00 00:00:00',
  `end_time_discovery` timestamp NULL NOT NULL DEFAULT '0000-00-00 00:00:00',
  `start_time_query` timestamp NULL NOT NULL DEFAULT '0000-00-00 00:00:00',
  `end_time_query` timestamp NULL NOT NULL DEFAULT '0000-00-00 00:00:00',
